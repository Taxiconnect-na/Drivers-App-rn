...
const fill = '#096ED4';
const data = [50, 10, 40, 95, 80, 56, 60];
const moneyMade = [350, 210, 410, 595, 780, 856, 0];
  ...
  renderError_modalView() {
    return (
      <ErrorModal
        ...
        error_status={'show_weeksEarningsAlternatives'}
        parentNode={this}
      />
    );
  }
        ...
        {this.state.loaderState === false && this.state.foundError === false ? (
                ...
                <View style={{paddingBottom: 20}}>
                  ...
                  <View style={{padding: 10, paddingTop: 0}}>
                    <XAxis
                      ...
                      data={moneyMade}
                      formatLabel={(_, index) => `N$${moneyMade[index]}`}
          ...
          <ScrollView
            ...
            <Text
              ...
              Oups, we couldn't retrieve your wallet insights, please try again.
              later.
            </Text>
          </ScrollView>
        )}
...
export default React.memo(connect(mapStateToProps)(EarningsScreenEntry));
