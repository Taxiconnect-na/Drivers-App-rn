...
class YourRidesEntry extends React.PureComponent {
  ...
  updateYourRidesSHownOnes(type) {
    ...
    this.props.UpdateType_rideShown_YourRides_screenTab(type);
  }
  ...
  fetchRequestedRequests_history(type = false) {
    ...
    this.props.App.socket.emit('getRides_historyRiders_batchOrNot', {
      ...
      ride_type: type === false ? this.props.App.shownRides_types_tab : type,
      user_nature: 'driver',
    });
  }
  ...
  pullRefreshRequest() {
    ...
    this.fetchRequestedRequests_history(this.props.App.shownRides_types_tab);
  }
