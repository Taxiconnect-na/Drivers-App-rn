...
const STATE = {
  ...
  _TMP_TRIP_INTERVAL_PERSISTER_TIME: 1300, //THe frequency of repetition - default:2s
  ...
  notifications_comm_data: {}, //Will hold all the related notifications comm data
};
