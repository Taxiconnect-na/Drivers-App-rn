...
class Splash extends React.PureComponent {
  ...
  async componentDidMount() {
    ...
    setTimeout(() => {
      if (
        globalApp.props.App.user_fingerprint !== undefined &&
        globalApp.props.App.user_fingerprint !== null &&
        globalApp.props.App.user_fingerprint !== false &&
        globalApp.props.App.user_fingerprint.length > 40
      ) {
